...
| npm(deps-dev): bump babel-jest from 30.0.5 to 30.1.2 | Medium | [#307](https://github.com/GauravKarakoti/Weather-API/pull/307) |
| npm(deps): bump express-rate-limit from 8.0.1 to 8.1.0 | Medium | [#306](https://github.com/GauravKarakoti/Weather-API/pull/306) |
| npm(deps-dev): bump eslint from 9.34.0 to 9.35.0 | Medium | [#305](https://github.com/GauravKarakoti/Weather-API/pull/305) |
| npm(deps): bump nodemailer from 7.0.5 to 7.0.6 | Medium | [#304](https://github.com/GauravKarakoti/Weather-API/pull/304) |
| npm(deps-dev): bump jest from 30.0.5 to 30.1.3 | Medium | [#303](https://github.com/GauravKarakoti/Weather-API/pull/303) |
| npm(deps-dev): bump @babel/core from 7.28.3 to 7.28.4 | Medium | [#302](https://github.com/GauravKarakoti/Weather-API/pull/302) |
| npm(deps): bump dotenv from 17.2.1 to 17.2.2 | Medium | [#301](https://github.com/GauravKarakoti/Weather-API/pull/301) |
| npm(deps): bump uuid from 9.0.1 to 12.0.0 | Medium | [#300](https://github.com/GauravKarakoti/Weather-API/pull/300) |
| npm(deps-dev): bump jest-environment-jsdom from 30.0.5 to 30.1.2 | Medium | [#299](https://github.com/GauravKarakoti/Weather-API/pull/299) |
