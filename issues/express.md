...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| npm(deps-dev): bump @babel/preset-env from 7.28.0 to 7.28.3 | Medium | [#285](https://github.com/GauravKarakoti/Weather-API/pull/285) |
| npm(deps): bump uuid from 9.0.1 to 11.1.0 | Medium | [#284](https://github.com/GauravKarakoti/Weather-API/pull/284) |
| npm(deps): bump redis from 4.7.1 to 5.8.1 | Medium | [#283](https://github.com/GauravKarakoti/Weather-API/pull/283) |
| npm(deps-dev): bump @babel/core from 7.28.0 to 7.28.3 | Medium | [#282](https://github.com/GauravKarakoti/Weather-API/pull/282) |
