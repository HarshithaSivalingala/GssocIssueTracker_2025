...
| Enhance Terminal Rendering with Debugging Metrics | Medium | [#41](https://github.com/18Prachi/airplane-boarding-simulation/issues/41) |
| Cascading Movement Bug | Medium | [#40](https://github.com/18Prachi/airplane-boarding-simulation/issues/40) |
...
| Code Refactoring | Medium | [#29](https://github.com/18Prachi/airplane-boarding-simulation/issues/29) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| LSTM Next word predictor using PyTorch | Medium | [#551](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/551) |
| Feature Request: Add Healthcare Chatbot (Gemini-powered) | Medium | [#550](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/550) |
| Add Fake News Detection Model | Medium | [#549](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/549) |
| Pull Request – Rock Paper Scissors Python Game | Medium | [#548](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/548) |
| Pull Request – Object Detection | Medium | [#547](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/547) |
| Pull Request – NLTK: A Guide to Natural Language Processing | Medium | [#546](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/546) |
| Pull Request of Naive Baye's Classification | Medium | [#545](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/545) |
| Mushroom Classifier (KNN, RandomForest, LogisticRegression) | Medium | [#544](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/544) |
| SSoC25 : Mushroom Classifier (KNN, RandomForest, LogisticRegression) | Medium | [#543](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/543) |
| Sms Spam Classifier using Naive BAyes (issue#541) | Medium | [#542](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/542) |
| SSoC25 : SMS Spam Classifier using Naive Bayes | Medium | [#541](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/541) |
| Added beginner-friendly EDA on Titanic dataset | Medium | [#540](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/540) |
| Addition of automate issue create message | Medium | [#539](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/539) |
| SSoC25 : Develop Ear Discomfort Predictor using Hearing Well-being Survey Data | Medium | [#535](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/535) |
| Added XGBoost  model and interactive streamlit dashboard for asteroid hazard prediction | Medium | [#530](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/530) |
| SSoC25 : Implement Blood Donation Volume Prediction Model | Medium | [#526](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/526) |
| SSoC25 : Add Blood Donor Availability Prediction Model | Medium | [#524](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/524) |
| Addition of automate issue create message | Medium | [#501](https://github.com/PRIYANSHU2026/DataSentience-AIML/issues/501) |
...
| Modular Streamlit Web Interface for the Entire Application | Medium | [#488](https://github.com/PRIYANSHU2026/DataSentience-AIML/pull/488) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Add Data Validation Module For Analyzing the Failure Data patterns | Medium | [#46](https://github.com/etsi-ai/etsi-failprint/issues/46) |
...
| implemented the hashed-passwd-storage mechanism | Medium | [#17](https://github.com/santhoshkumar1204/hotel-table-reservation-system/pull/17) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| 🔤 SuffixAutomaton: Suffix Automaton for String Processing | Medium | [#1710](https://github.com/UTSAVS26/PyVerse/issues/1710) |
| 🌳 SplayTree: Self-Adjusting Binary Search Tree | Medium | [#1709](https://github.com/UTSAVS26/PyVerse/issues/1709) |
| 📊 SparseTable: Range Query Data Structure | Medium | [#1708](https://github.com/UTSAVS26/PyVerse/issues/1708) |
| 🚀 SkipListDB: High-Performance Probabilistic Database Index | Medium | [#1707](https://github.com/UTSAVS26/PyVerse/issues/1707) |
| 🔥 SimulatedAnnealing: Optimization Algorithm | Medium | [#1706](https://github.com/UTSAVS26/PyVerse/issues/1706) |
| 🔢 PrimeSieve: High-Performance Prime Number Generator | Medium | [#1705](https://github.com/UTSAVS26/PyVerse/issues/1705) |
| 🪢 RopeDS: Rope Data Structure for Text Processing | Medium | [#1704](https://github.com/UTSAVS26/PyVerse/issues/1704) |
| 📍 PointInPolygon: Geometric Point Location Engine | Medium | [#1703](https://github.com/UTSAVS26/PyVerse/issues/1703) |
| 📚 PersistentDS: Persistent Data Structures Library | Medium | [#1702](https://github.com/UTSAVS26/PyVerse/issues/1702) |
| 📊 MoSAlgorithm: Range Query Optimization Engine | Medium | [#1701](https://github.com/UTSAVS26/PyVerse/issues/1701) |
| 🎲 MCTS-AI: Monte Carlo Tree Search Engine | Medium | [#1700](https://github.com/UTSAVS26/PyVerse/issues/1700) |
| 🔢 ModExp: Modular Exponentiation Calculator | Medium | [#1699](https://github.com/UTSAVS26/PyVerse/issues/1699) |
| 🌲 MST-Solver: Minimum Spanning Tree Algorithms | Medium | [#1698](https://github.com/UTSAVS26/PyVerse/issues/1698) |
| 🎭 ManacherPalindrome: Longest Palindromic Substring Finder | Medium | [#1697](https://github.com/UTSAVS26/PyVerse/issues/1697) |
| 🔗 LinkCutTree: Dynamic Tree Data Structure | Medium | [#1696](https://github.com/UTSAVS26/PyVerse/issues/1696) |
| 📐 GeometrySolver: Line Segment Intersection Engine | Medium | [#1695](https://github.com/UTSAVS26/PyVerse/issues/1695) |
| 🔄 KosarajuSCC: Strongly Connected Components Finder | Medium | [#1694](https://github.com/UTSAVS26/PyVerse/issues/1694) |
| 🎯 JarvisMarch: Convex Hull Algorithm | Medium | [#1693](https://github.com/UTSAVS26/PyVerse/issues/1693) |
| 🌳 HeavyPathDecompositionEnhanced: Advanced Tree Query & Update Engine | Medium | [#1692](https://github.com/UTSAVS26/PyVerse/issues/1692) |
| 🌳 HLD-Tree: Heavy Light Decomposition for Tree Queries | Medium | [#1691](https://github.com/UTSAVS26/PyVerse/issues/1691) |
...
📝 **Description:** A simple Python-based CLI app to manage student grades  add marks, calculate average, highest, and lowest scores  all stored locally in a clean JSON format. Perfect for beginners learning Python and file handling.

🔗 [View Project](https://github.com/Archita0905/Student-Grade-Tracker)
...
| Improve Student Record System: Roll No Access, Authentication, Sorting, Redundancy Handling | Medium | [#36](https://github.com/Archita0905/Student-Grade-Tracker/issues/36) |
| Fix: Add input validation and error handling for user inputs | Medium | [#35](https://github.com/Archita0905/Student-Grade-Tracker/pull/35) |
| Add input validation and error handling for user inputs | Medium | [#34](https://github.com/Archita0905/Student-Grade-Tracker/issues/34) |
| Add Letter Grade Mapping to Student Report | Medium | [#33](https://github.com/Archita0905/Student-Grade-Tracker/pull/33) |
| Add Letter Grading to student report | Medium | [#32](https://github.com/Archita0905/Student-Grade-Tracker/issues/32) |
| Add Import Student Data from CSV/JSON File | Medium | [#31](https://github.com/Archita0905/Student-Grade-Tracker/pull/31) |
| Add Import Student Data from File | Medium | [#30](https://github.com/Archita0905/Student-Grade-Tracker/issues/30) |
| Added Feature/export report | Medium | [#29](https://github.com/Archita0905/Student-Grade-Tracker/pull/29) |
| added edit/update student | Medium | [#28](https://github.com/Archita0905/Student-Grade-Tracker/pull/28) |
| ➕ Added delete student feature and updated menu | Medium | [#26](https://github.com/Archita0905/Student-Grade-Tracker/pull/26) |
| Export Report to Text or CSV | Medium | [#25](https://github.com/Archita0905/Student-Grade-Tracker/issues/25) |
| Display Class Summary Stats | Medium | [#24](https://github.com/Archita0905/Student-Grade-Tracker/issues/24) |
| Add Edit/Update Student Records functionality | Medium | [#23](https://github.com/Archita0905/Student-Grade-Tracker/pull/23) |
| 🐛 Add Edit/Update Student Functionality | Medium | [#22](https://github.com/Archita0905/Student-Grade-Tracker/issues/22) |
| Add input validation and error handling | Medium | [#21](https://github.com/Archita0905/Student-Grade-Tracker/pull/21) |
| 🐛 Implement input validation for student grades | Medium | [#20](https://github.com/Archita0905/Student-Grade-Tracker/issues/20) |
| 🛠️ Issue: Improve CLI UX and Extend Features in Student Grade Tracker | Medium | [#19](https://github.com/Archita0905/Student-Grade-Tracker/issues/19) |
| Create License | Medium | [#18](https://github.com/Archita0905/Student-Grade-Tracker/pull/18) |
| Added delete and topper feature to student tracker | Medium | [#17](https://github.com/Archita0905/Student-Grade-Tracker/pull/17) |
...
| Feature: Track and Plot Student Performance Over Time | Medium | [#8](https://github.com/Archita0905/Student-Grade-Tracker/issues/8) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Bug Report: Federated Learning Not Using Global Parameters | Medium | [#6](https://github.com/harshajain6114/Federated-learning-for-crpto-fraud/issues/6) |
...
🔗 [View Project](https://github.com/kasmya/AI-Cosmetic-Reccomendation-System)
...
📝 **Description:** The To-Do List Application is a simple Python-based project that helps users manage their daily tasks efficiently. Users can add new tasks, view the list of pending tasks, mark tasks as completed, and delete tasks they no longer need.
...
🔗 [View Project](https://github.com/Sindhuchowdhary23/CODSOFT)
...
| <new feature > adding dark mode toggle | Medium | [#35](https://github.com/Sindhuchowdhary23/CODSOFT/issues/35) |
| Wrong run command in README for Streamlit app | Medium | [#34](https://github.com/Sindhuchowdhary23/CODSOFT/issues/34) |
| Add Undo Functionality for Recently Deleted Task | Medium | [#33](https://github.com/Sindhuchowdhary23/CODSOFT/issues/33) |
| minor changes in previous commit | Medium | [#32](https://github.com/Sindhuchowdhary23/CODSOFT/pull/32) |
| Task Due Dates or Deadlines | Medium | [#31](https://github.com/Sindhuchowdhary23/CODSOFT/pull/31) |
| Proposal: Add Task Categorization Feature (Tags/Priority Levels) | Medium | [#30](https://github.com/Sindhuchowdhary23/CODSOFT/issues/30) |
| added the due date feature | Medium | [#29](https://github.com/Sindhuchowdhary23/CODSOFT/pull/29) |
| task1.py saving the items in todo-list and UI added | Medium | [#28](https://github.com/Sindhuchowdhary23/CODSOFT/pull/28) |
| Responsive Design & accessibility | Medium | [#27](https://github.com/Sindhuchowdhary23/CODSOFT/issues/27) |
| UI Enhancement with Basic JavaScript and Improved Styling | Medium | [#26](https://github.com/Sindhuchowdhary23/CODSOFT/issues/26) |
| Update Readme file | Medium | [#23](https://github.com/Sindhuchowdhary23/CODSOFT/pull/23) |
| Add Keyboard Shortcuts to To‑Do List UI | Medium | [#22](https://github.com/Sindhuchowdhary23/CODSOFT/issues/22) |
| Save load tasksTitle: Add JSON-based task persistence to To-Do app | Medium | [#21](https://github.com/Sindhuchowdhary23/CODSOFT/pull/21) |
| Suggestion: Add Code Of Conduct File to project | Medium | [#20](https://github.com/Sindhuchowdhary23/CODSOFT/issues/20) |
| Enhance the ui more better and connect to database | Medium | [#18](https://github.com/Sindhuchowdhary23/CODSOFT/issues/18) |
| Title: Refactor To-Do CLI into Modular Architecture for Better Maintainability | Medium | [#17](https://github.com/Sindhuchowdhary23/CODSOFT/pull/17) |
| Suggestion: Add a CONTRIBUTING.md File to project | Medium | [#16](https://github.com/Sindhuchowdhary23/CODSOFT/issues/16) |
| 🚫 License Missing from Repository | Medium | [#15](https://github.com/Sindhuchowdhary23/CODSOFT/issues/15) |
| Created README.md | Medium | [#6](https://github.com/Sindhuchowdhary23/CODSOFT/pull/6) |
...
🔗 [View Project](https://github.com/nupurmadaan04/AI-agriculture-yield-production)
...
| Fixed the error in processing notebook | Medium | [#36](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/36) |
| Create a streamlit UI for  Interactive Yield Prediction | Medium | [#35](https://github.com/nupurmadaan04/AI-agriculture-yield-production/issues/35) |
| Enhance EDA with Univariate and Multivariate Analysis | Medium | [#34](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/34) |
| Perform Enhanced EDA with Univariate and Multivariate Analysis | Medium | [#33](https://github.com/nupurmadaan04/AI-agriculture-yield-production/issues/33) |
| Revert "Fixed Issue  #9 and #7  - Added Error Analysis and an Interactive Dashboard" | Medium | [#32](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/32) |
| The link is not working for license | Medium | [#31](https://github.com/nupurmadaan04/AI-agriculture-yield-production/issues/31) |
...
| Add comprehensive unit testing suite and test runner for data preprocessing | Medium | [#28](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/28) |
| Improve EDA in 02_eda.ipynb | Medium | [#27](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/27) |
| Added Templates | Medium | [#26](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/26) |
| Fix issue #15 : Modularize Evaluation Metrics | Medium | [#19](https://github.com/nupurmadaan04/AI-agriculture-yield-production/pull/19) |
...
🔗 [View Project](https://github.com/RafiaShafique/Tic-Tae-Toe-Game)
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Dark Mode Toggle | Medium | [#11](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/11) |
| Build Basic UI and Game Logic for Tic Tac Toe using Python & Pygame | Medium | [#10](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/10) |
| Enhancing UI & Visual Features | Medium | [#9](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/9) |
| Documentation : Updating README.md File for Better Project Documentation | Medium | [#8](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/8) |
| Suggestion: Add a CONTRIBUTING.md File to project | Medium | [#7](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/7) |
| Documentation : Add Code Of Conduct File to project | Medium | [#6](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/6) |
| AI Enabled Single Player mode | Medium | [#5](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/5) |
| Add Draw feature | Medium | [#4](https://github.com/RafiaShafique/Tic-Tae-Toe-Game/issues/4) |
...
🔗 [View Project](https://github.com/shoryasethia/markdrop)
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Add Feature : AI & Enrichment | Medium | [#11](https://github.com/shoryasethia/markdrop/issues/11) |
| Documentation : Add Code Of Conduct File to project | Medium | [#10](https://github.com/shoryasethia/markdrop/issues/10) |
| Architectural and Codebase Integrity Issues: Hardcoded Paths, Logging Redundancy, and Missing Test Coverage | Medium | [#9](https://github.com/shoryasethia/markdrop/issues/9) |
| Critical Inconsistency in Environment Variable Handling for Gemini API Key Across Modules | Medium | [#8](https://github.com/shoryasethia/markdrop/issues/8) |
| Create SRS and Design | Medium | [#3](https://github.com/shoryasethia/markdrop/issues/3) |

---

## 📌 Project: Personal AI desktop Assistant

📝 **Description:** handle desktop task

🔗 [View Project](https://github.com/simrkadak/Personal-AI-Desktop-Assistant)
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Enhance Multi-step Task Execution and Prevent Prompt Hallucination | Medium | [#12](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/12) |
| 🌤️ Add Weather Feature and Comprehensive Documentation Update | Medium | [#11](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/pull/11) |
| Add a Fallback Message | Medium | [#10](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/10) |
| Add Help or Tutorial Mode | Medium | [#9](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/9) |
| Add Templates for pull requests , issues | Medium | [#7](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/7) |
| Add Weather Information Feature | Medium | [#6](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/6) |
| Critical Error Handling Missing in Voice Recognition | Medium | [#5](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/5) |
| Add a CONTRIBUTING.md File | Medium | [#4](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/4) |
| Add code of conduct | Medium | [#3](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/3) |
| Enhance README.md for Better Clarity, Structure, and Visual Appeal | Medium | [#2](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/2) |
| License Missing | Medium | [#1](https://github.com/simrkadak/Personal-AI-Desktop-Assistant/issues/1) |
...
🔗 [View Project](https://github.com/swayum1004/StockSentry)
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Added Logs | Medium | [#30](https://github.com/swayum1004/StockSentry/pull/30) |
| Added Templates | Medium | [#29](https://github.com/swayum1004/StockSentry/pull/29) |
| Create CODE_OF_CONDUCT.md | Medium | [#28](https://github.com/swayum1004/StockSentry/pull/28) |
...
📝 **Description:** a tool that encrypt ant file

🔗 [View Project](https://github.com/vishesh4560/File-encryption-tool)
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Added Multi-Encryption Support (AES + Fernet) with GUI Algorithm Selector | Medium | [#12](https://github.com/vishesh4560/File-encryption-tool/pull/12) |
| Improve Documentation, Add License, and Enhance Code Quality | Medium | [#11](https://github.com/vishesh4560/File-encryption-tool/pull/11) |
| Documentation : Add Code Of Conduct File to project | Medium | [#10](https://github.com/vishesh4560/File-encryption-tool/issues/10) |
| Issue: Improve File Encryption GUI and Code Robustness | Medium | [#9](https://github.com/vishesh4560/File-encryption-tool/issues/9) |
| Add CONTRIBUTING.md | Medium | [#8](https://github.com/vishesh4560/File-encryption-tool/issues/8) |
| 🚫 License Missing from Repository | Medium | [#7](https://github.com/vishesh4560/File-encryption-tool/issues/7) |
| Overwriting Original Files Without Backup | Medium | [#6](https://github.com/vishesh4560/File-encryption-tool/issues/6) |
| Encrypting files multiple times | Medium | [#5](https://github.com/vishesh4560/File-encryption-tool/issues/5) |
| Improve Code Quality and Maintainability - Add Type Hints, Docstrings, and Refactor Structure | Medium | [#4](https://github.com/vishesh4560/File-encryption-tool/issues/4) |
