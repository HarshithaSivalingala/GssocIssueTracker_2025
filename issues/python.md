...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Fix: improved UI and added Privacy Policy page (issue #201) | Medium | [#347](https://github.com/Amarjha01/InfantCareCompass/pull/347) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Feature Request: Add Smart Donation Pickup Tracking System (Google Maps API Integration)Add a Donation Pickup Tracking feature that allows donors and volunteers to view pickup and delivery locations in real-time using Google Maps API. | Medium | [#39](https://github.com/Khushbudaswani/Foodbridge/issues/39) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Add Stochastic Passenger Behavior & Color Coded Visualization | Medium | [#55](https://github.com/18Prachi/airplane-boarding-simulation/issues/55) |
| Improved model performance by adding new functionalities | Medium | [#54](https://github.com/18Prachi/airplane-boarding-simulation/pull/54) |
...
| 🔖 Title | 🎯 Difficulty | 🔗 Link |
|----------|----------------|---------|
| Benchmark on OmniDocBench | Medium | [#13](https://github.com/shoryasethia/markdrop/issues/13) |
